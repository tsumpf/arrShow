...
% $Revision: 1.15 $  $Date: 2009/02/27 05:41:53 $
...
%% Traverse the container hierarchy and extract the elements within
    function traverseContainer(jcontainer,level,parent)
        ...
        try
            positions(thisIdx,:) = [get(jcontainer,'X'), get(jcontainer,'Y')];  %getX/getY are better (mem leaks) but sometimes fail and revert to getx.m ...
        ...
        try
            ...
            for childIdx = 0 : numChildren-1
                ...
                if childNode.isLeafNode
                    ...
                    try
                        visible = childNode.getUserObject.isVisible;
                    catch
                        visible = 1;
                    end
...
%% TODO TODO TODO
%{
- Enh: Improve performance - esp. expandNode() & traverseContainer()
